...
<caption>Klik pada acara untuk mengugurkan acara tersebut</caption>
    ...
    //Mengambil data yang dipilih di L1
...
/*Mengambil data dari table acara_ahli dan acara berdasarkan nokp yang telah diambil*/
        ...
        //Memaparkan data yang diambil di L3 baris demi baris
    echo"<tr ".$warna.">
...
?>
<!--Memanggil file cetak di button untuk mencetak-->
<a href="CETAK1.php" target="_blank">CETAK</a>
